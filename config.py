...
APP_ID = int(os.environ.get("APP_ID", "25674626"))

#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "28e65eaa64a572e5a955b0bb17a15204")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002211148865"))
